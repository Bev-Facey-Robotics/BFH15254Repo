...
public final class TwoDeadWheelLocalizer implements Localizer {
    ...
    public final Encoder EncF, EncS;
    ...
    public TwoDeadWheelLocalizer(HardwareMap hardwareMap, IMU imu, double inPerTick) {
        ...
        EncF = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "EncF")));
        EncS = new OverflowEncoder(new RawEncoder(hardwareMap.get(DcMotorEx.class, "EncS")));
    ...
    public Twist2dDual<Time> update() {
        PositionVelocityPair parPosVel = EncF.getPositionAndVelocity();
        PositionVelocityPair perpPosVel = EncS.getPositionAndVelocity();
