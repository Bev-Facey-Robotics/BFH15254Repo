...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  5618.777619453317; // y position of the parallel encoder (in tick units) // confusion
        public double perpXTicks = -5328.632405298983; // x position of the perpendicular encoder (in tick units)
    }
