...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  5258.500922146566; // y position of the parallel encoder (in tick units) // confusion
        public double perpXTicks = -5563.928592348811; // x position of the perpendicular encoder (in tick units)
    }
